            ...
            <div class="tab-panel" data-tab="logo">
                ...
                @component('admin.components.locale', ['tab' => 'logo'])
                    ...
                    @foreach ($localizations as $localization)
                        ...
                        <div class="locale-panel {{ $loop->first ? 'locale-active':'' }}" data-tab="logo" data-localetab="{{$localization->alias}}">
            ...
            <div class="tab-panel" data-tab="socials">
                ...
                @component('admin.components.locale', ['tab' => 'socials'])
                    ...
                    @foreach ($localizations as $localization)
                        ...
                        <div class="locale-panel {{ $loop->first ? 'locale-active':'' }}" data-tab="socials" data-localetab="{{$localization->alias}}">
            ...
            <div class="tab-panel" data-tab="presentation">
                ...
                @component('admin.components.locale', ['tab' => 'presentation'])
                    ...
                    @foreach ($localizations as $localization)
                        ...
                        <div class="locale-panel {{ $loop->first ? 'locale-active':'' }}" data-tab="presentation" data-localetab="{{$localization->alias}}">
